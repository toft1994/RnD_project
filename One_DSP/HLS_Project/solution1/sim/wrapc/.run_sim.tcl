...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "nnlayer.autotvin.dat"
	set constFileTvOut       "nnlayer.autotvout.dat"
	set constFileHdlTvIn     "nnlayer.autohdltvin.dat"
	set constFileHdlTvOut    "nnlayer.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
