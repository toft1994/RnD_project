...
attribute shreg_extract : string;
    ...
    signal loop_index_fu_40 : STD_LOGIC_VECTOR (7 downto 0);
    signal empty_18_fu_85_p2 : STD_LOGIC_VECTOR (7 downto 0);
...
begin
        ...
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if (((exitcond9_fu_79_p2 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1))) then 
                    ...
                    loop_index_fu_40 <= ap_const_lv8_0;
                end if;
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((exitcond9_fu_79_p2 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                    loop_index_cast_reg_111(7 downto 0) <= loop_index_cast_fu_91_p1(7 downto 0);
            end if;
        end if;
    end process;
    loop_index_cast_reg_111(63 downto 8) <= "00000000000000000000000000000000000000000000000000000000";
    ...
    empty_18_fu_85_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_loop_index_load) + unsigned(ap_const_lv8_1));
    exitcond9_fu_79_p2 <= "1" when (ap_sig_allocacmp_loop_index_load = ap_const_lv8_80) else "0";
