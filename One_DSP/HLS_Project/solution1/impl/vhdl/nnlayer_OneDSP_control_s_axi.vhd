...
entity nnlayer_OneDSP_control_s_axi is
generic (
...
end entity nnlayer_OneDSP_control_s_axi;
...
architecture behave of nnlayer_OneDSP_control_s_axi is
    ...
    component nnlayer_OneDSP_control_s_axi_ram is
        generic (
    ...
    end component nnlayer_OneDSP_control_s_axi_ram;
...
-- ----------------------- Instantiation------------------
-- int_input_r
int_input_r : nnlayer_OneDSP_control_s_axi_ram
generic map (
     MEM_STYLE => "auto",
     MEM_TYPE  => "2P",
     BYTES     => 4,
...
port map (
     ...
     q1        => int_input_r_q1);
-- int_output_r
int_output_r : nnlayer_OneDSP_control_s_axi_ram
generic map (
     MEM_STYLE => "auto",
     MEM_TYPE  => "S2P",
     BYTES     => 4,
...
port map (
     ...
     q1        => int_output_r_q1);
-- int_bias
int_bias : nnlayer_OneDSP_control_s_axi_ram
generic map (
     MEM_STYLE => "auto",
     MEM_TYPE  => "2P",
     BYTES     => 4,
...
port map (
     ...
     q1        => int_bias_q1);
-- int_weights
int_weights : nnlayer_OneDSP_control_s_axi_ram
generic map (
     MEM_STYLE => "auto",
     MEM_TYPE  => "2P",
     BYTES     => 4,
...
entity nnlayer_OneDSP_control_s_axi_ram is
    generic (
        MEM_STYLE : STRING :="auto";
        MEM_TYPE  : STRING :="S2P";
        BYTES   : INTEGER :=4;
...
end entity nnlayer_OneDSP_control_s_axi_ram;

architecture behave of nnlayer_OneDSP_control_s_axi_ram is
