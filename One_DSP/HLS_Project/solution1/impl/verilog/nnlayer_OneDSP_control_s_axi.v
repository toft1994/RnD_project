...
// ==============================================================
`timescale 1ns/1ps
module nnlayer_OneDSP_control_s_axi
#(parameter
...
localparam
    ...
    ADDR_IER                       = 16'h0008,
    ADDR_ISR                       = 16'h000c,
    ADDR_NUMOFINNEURONS_DATA_0     = 16'h0010,
    ADDR_NUMOFINNEURONS_CTRL       = 16'h0014,
...
//------------------------Instantiation------------------
// int_input_r
nnlayer_OneDSP_control_s_axi_ram #(
    .MEM_STYLE ( "auto" ),
    .MEM_TYPE  ( "2P" ),
    .BYTES     ( 4 ),
    .DEPTH     ( 64 )
...
module nnlayer_OneDSP_control_s_axi_ram
#(parameter
    MEM_STYLE = "auto",
    MEM_TYPE  = "S2P",
    BYTES  = 4,
