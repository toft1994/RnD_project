...
#(parameter
    ...
    input  wire [3:0]                    input_r_address0,
    ...
    input  wire [7:0]                    weights_address0,
...
localparam
    ...
    ADDR_IER                    = 10'h008,
    ADDR_ISR                    = 10'h00c,
    ADDR_NUMOFINNEURONS_DATA_0  = 10'h010,
    ADDR_NUMOFINNEURONS_CTRL    = 10'h014,
    ADDR_NUMOFOUTNEURONS_DATA_0 = 10'h018,
    ADDR_NUMOFOUTNEURONS_CTRL   = 10'h01c,
    ADDR_ACTIVATION_DATA_0      = 10'h080,
    ADDR_ACTIVATION_CTRL        = 10'h084,
    ADDR_INPUT_R_BASE           = 10'h020,
    ADDR_INPUT_R_HIGH           = 10'h03f,
    ADDR_OUTPUT_R_BASE          = 10'h040,
    ADDR_OUTPUT_R_HIGH          = 10'h05f,
    ADDR_BIAS_BASE              = 10'h060,
    ADDR_BIAS_HIGH              = 10'h07f,
    ADDR_WEIGHTS_BASE           = 10'h200,
    ADDR_WEIGHTS_HIGH           = 10'h3ff,
    WRIDLE                      = 2'd0,
    WRDATA                      = 2'd1,
    WRRESP                      = 2'd2,
    WRRESET                     = 2'd3,
...
//------------------------Local signal-------------------
    ...
    // memory signals
    wire [2:0]                    int_input_r_address0;
    wire                          int_input_r_ce0;
    wire [31:0]                   int_input_r_q0;
    wire [2:0]                    int_input_r_address1;
    ...
    wire [6:0]                    int_weights_address0;
    wire                          int_weights_ce0;
    wire [31:0]                   int_weights_q0;
    wire [6:0]                    int_weights_address1;
...
assign int_input_r_address1  = ar_hs? raddr[4:2] : waddr[4:2];
...
assign int_weights_address1  = ar_hs? raddr[8:2] : waddr[8:2];
