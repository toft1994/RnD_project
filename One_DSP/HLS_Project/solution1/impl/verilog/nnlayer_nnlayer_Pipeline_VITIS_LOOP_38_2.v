...
module nnlayer_nnlayer_Pipeline_VITIS_LOOP_38_2 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [63:0] zext_ln40_fu_171_p1;
reg   [8:0] inc3740_i_fu_74;
wire   [8:0] add_ln38_fu_165_p2;
wire    ap_loop_init;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln38_fu_159_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
always @ (posedge ap_clk) begin
    if (((icmp_ln38_fu_159_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ifzero_reg_270 <= ifzero_fu_176_p2;
    end
end

always @ (*) begin
    if (((icmp_ln38_fu_159_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((icmp_ln38_fu_159_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ifzero_fu_176_p2 == 1'd1))) begin
...
assign add_ln38_fu_165_p2 = (ap_sig_allocacmp_inc3740_i_load + 9'd1);
...
assign icmp_ln38_fu_159_p2 = ((ap_sig_allocacmp_inc3740_i_load == 9'd256) ? 1'b1 : 1'b0);

assign idxprom7_i_cast_fu_141_p1 = idxprom7_i;

assign ifzero_fu_176_p2 = ((add_ln38_fu_165_p2 == 9'd256) ? 1'b1 : 1'b0);

assign input_r_address0 = zext_ln40_fu_171_p1;

assign outNeurons = add_ln35;
...
assign weightIndexAdded = add_ln42;

assign zext_ln40_fu_171_p1 = ap_sig_allocacmp_inc3740_i_load;

endmodule //nnlayer_nnlayer_Pipeline_VITIS_LOOP_38_2
