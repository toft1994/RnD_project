...
void XNnlayer_Set_numOfInputNeurons(XNnlayer *InstancePtr, u32 Data) {
    ...
    XNnlayer_WriteReg(InstancePtr->Control_BaseAddress, XNNLAYER_CONTROL_ADDR_NUMOFINPUTNEURONS_DATA, Data);
}
...
u32 XNnlayer_Get_numOfInputNeurons(XNnlayer *InstancePtr) {
    ...
    Data = XNnlayer_ReadReg(InstancePtr->Control_BaseAddress, XNNLAYER_CONTROL_ADDR_NUMOFINPUTNEURONS_DATA);
    return Data;
}
