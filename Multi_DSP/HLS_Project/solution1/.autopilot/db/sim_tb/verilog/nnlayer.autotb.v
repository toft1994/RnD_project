...
`define AUTOTB_DUT      nnlayer
`define AUTOTB_DUT_INST AESL_inst_nnlayer
`define AUTOTB_TOP      apatb_nnlayer_top
`define AUTOTB_LAT_RESULT_FILE "nnlayer.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "nnlayer.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_nnlayer_top
...
`define AESL_DEPTH_numOfInputNeurons 1
`define AESL_DEPTH_numOfOutputNeurons 1
`define AESL_DEPTH_activation 1
`define AESL_DEPTH_ap_local_deadlock 1
`define AUTOTB_TVIN_input_r  "./c.nnlayer.autotvin_input_r.dat"
`define AUTOTB_TVIN_bias  "./c.nnlayer.autotvin_bias.dat"
`define AUTOTB_TVIN_weights  "./c.nnlayer.autotvin_weights.dat"
`define AUTOTB_TVIN_numOfInputNeurons  "./c.nnlayer.autotvin_numOfInputNeurons.dat"
`define AUTOTB_TVIN_numOfOutputNeurons  "./c.nnlayer.autotvin_numOfOutputNeurons.dat"
`define AUTOTB_TVIN_activation  "./c.nnlayer.autotvin_activation.dat"
`define AUTOTB_TVIN_input_r_out_wrapc  "./rtl.nnlayer.autotvin_input_r.dat"
`define AUTOTB_TVIN_bias_out_wrapc  "./rtl.nnlayer.autotvin_bias.dat"
`define AUTOTB_TVIN_weights_out_wrapc  "./rtl.nnlayer.autotvin_weights.dat"
`define AUTOTB_TVIN_numOfInputNeurons_out_wrapc  "./rtl.nnlayer.autotvin_numOfInputNeurons.dat"
`define AUTOTB_TVIN_numOfOutputNeurons_out_wrapc  "./rtl.nnlayer.autotvin_numOfOutputNeurons.dat"
`define AUTOTB_TVIN_activation_out_wrapc  "./rtl.nnlayer.autotvin_activation.dat"
`define AUTOTB_TVOUT_output_r  "./c.nnlayer.autotvout_output_r.dat"
`define AUTOTB_TVOUT_output_r_out_wrapc  "./impl_rtl.nnlayer.autotvout_output_r.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 4;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = -1;
parameter LENGTH_input_r = 128;
parameter LENGTH_output_r = 128;
parameter LENGTH_bias = 128;
parameter LENGTH_weights = 16384;
parameter LENGTH_numOfInputNeurons = 1;
parameter LENGTH_numOfOutputNeurons = 1;
parameter LENGTH_activation = 1;
...
reg end_numOfInputNeurons;
reg [31:0] size_numOfInputNeurons;
reg [31:0] size_numOfInputNeurons_backup;
reg end_numOfOutputNeurons;
reg [31:0] size_numOfOutputNeurons;
reg [31:0] size_numOfOutputNeurons_backup;
reg end_activation;
reg [31:0] size_activation;
reg [31:0] size_activation_backup;
reg end_output_r;
