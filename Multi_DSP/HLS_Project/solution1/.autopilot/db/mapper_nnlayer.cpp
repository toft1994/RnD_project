...
extern "C" void apatb_nnlayer_hw(volatile void * __xlx_apatb_param_input_r, volatile void * __xlx_apatb_param_output_r, volatile void * __xlx_apatb_param_bias, volatile void * __xlx_apatb_param_weights, short __xlx_apatb_param_numOfInputNeurons, short __xlx_apatb_param_numOfOutputNeurons, char __xlx_apatb_param_activation) {
  ...
  // DUT call
  nnlayer(__xlx_input_r__input_buffer, __xlx_output_r__input_buffer, __xlx_bias__input_buffer, __xlx_weights__input_buffer, __xlx_apatb_param_numOfInputNeurons, __xlx_apatb_param_numOfOutputNeurons, __xlx_apatb_param_activation);
