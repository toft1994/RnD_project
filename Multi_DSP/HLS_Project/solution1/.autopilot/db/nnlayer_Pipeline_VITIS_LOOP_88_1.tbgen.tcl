set moduleName nnlayer_Pipeline_VITIS_LOOP_88_1
set isTopModule 0
...
set C_modelName {nnlayer_Pipeline_VITIS_LOOP_88_1}
set C_modelType { void 0 }
set C_modelArgList {
	{ numOfOutputNeurons int 16 regular  }
	{ bias int 16 regular {array 128 { 1 } 1 1 }  }
	{ output_V int 16 regular {array 128 { 0 3 } 0 1 } {global 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "numOfOutputNeurons", "interface" : "wire", "bitwidth" : 16, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "output_V", "interface" : "memory", "bitwidth" : 16, "direction" : "WRITEONLY", "extern" : 0} ]}
...
set Spec2ImplPortList { 
	...
	bias { ap_memory {  { bias_address0 mem_address 1 7 }  { bias_ce0 mem_ce 1 1 }  { bias_q0 in_data 0 16 } } }
	output_V { ap_memory {  { output_V_address0 mem_address 1 7 }  { output_V_ce0 mem_ce 1 1 }  { output_V_we0 mem_we 1 1 }  { output_V_d0 mem_din 1 16 } } }
}
