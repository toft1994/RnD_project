...
#define AUTOTB_TVOUT_numOfInputNeurons "../tv/cdatafile/c.nnlayer.autotvout_numOfInputNeurons.dat"
// wrapc file define:
...
// tvout file define:
#define AUTOTB_TVOUT_PC_numOfInputNeurons "../tv/rtldatafile/rtl.nnlayer.autotvout_numOfInputNeurons.dat"
// tvout file define:
...
string get_depth_list () {
  ...
  total_list << "{numOfInputNeurons " << numOfInputNeurons_depth << "}\n";
...
extern "C" void apatb_nnlayer_hw(volatile void * __xlx_apatb_param_input_r, volatile void * __xlx_apatb_param_output_r, volatile void * __xlx_apatb_param_bias, volatile void * __xlx_apatb_param_weights, short __xlx_apatb_param_numOfInputNeurons, short __xlx_apatb_param_numOfOutputNeurons, char __xlx_apatb_param_activation) {
...
#endif
// print numOfInputNeurons Transactions
{
aesl_fh.write(AUTOTB_TVIN_numOfInputNeurons, begin_str(AESL_transaction));
{
    sc_bv<16> __xlx_tmp_lv = *((short*)&__xlx_apatb_param_numOfInputNeurons);
aesl_fh.write(AUTOTB_TVIN_numOfInputNeurons, __xlx_tmp_lv.to_string(SC_HEX)+string("\n"));
}
  tcl_file.set_num(1, &tcl_file.numOfInputNeurons_depth);
aesl_fh.write(AUTOTB_TVIN_numOfInputNeurons, end_str());
}
...
nnlayer_hw_stub_wrapper(__xlx_apatb_param_input_r, __xlx_apatb_param_output_r, __xlx_apatb_param_bias, __xlx_apatb_param_weights, __xlx_apatb_param_numOfInputNeurons, __xlx_apatb_param_numOfOutputNeurons, __xlx_apatb_param_activation);
