...
architecture behave of nnlayer_nnI1_s_axi is
    type states is (wridle, wrdata, wrresp, wrreset, rdidle, rddata, rdreset);  -- read and write fsm states
    signal wstate  : states := wrreset;
    signal rstate  : states := rdreset;
    signal wnext, rnext: states;
    constant ADDR_INPUT_R_BASE : INTEGER := 16#400#;
    constant ADDR_INPUT_R_HIGH : INTEGER := 16#7ff#;
    ...
    -- memory signals
    signal int_input_r_address0 : UNSIGNED(7 downto 0);
    signal int_input_r_ce0     : STD_LOGIC;
    signal int_input_r_q0      : UNSIGNED(31 downto 0);
    signal int_input_r_address1 : UNSIGNED(7 downto 0);
    ...
    component nnlayer_nnI1_s_axi_ram is
        generic (
    ...
    end component nnlayer_nnI1_s_axi_ram;
...
-- ----------------------- Instantiation------------------
-- int_input_r
int_input_r : nnlayer_nnI1_s_axi_ram
generic map (
     MEM_STYLE => "block",
     MEM_TYPE  => "2P",
     BYTES     => 4,
...
-- ----------------------- Memory logic ------------------
    ...
    int_input_r_address1 <= raddr(9 downto 2) when ar_hs = '1' else waddr(9 downto 2);
...
entity nnlayer_nnI1_s_axi_ram is
    generic (
        MEM_STYLE : STRING :="auto";
        MEM_TYPE  : STRING :="S2P";
        BYTES   : INTEGER :=4;
...
end entity nnlayer_nnI1_s_axi_ram;

architecture behave of nnlayer_nnI1_s_axi_ram is
