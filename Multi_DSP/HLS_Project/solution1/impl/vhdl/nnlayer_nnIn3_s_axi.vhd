...
port (
    ...
    weights_q0            :out  STD_LOGIC_VECTOR(31 downto 0)
);
end entity nnlayer_nnIn3_s_axi;

-- ------------------------Address Info-------------------
-- 0x40000 ~
-- 0x7ffff : Memory 'weights' (65536 * 32b)
--           Word n : bit [31:0] - weights[n]
-- (SC = Self Clear, COR = Clear on Read, TOW = Toggle on Write, COH = Clear on Handshake)

architecture behave of nnlayer_nnIn3_s_axi is
    type states is (wridle, wrdata, wrresp, wrreset, rdidle, rddata, rdreset);  -- read and write fsm states
    signal wstate  : states := wrreset;
    signal rstate  : states := rdreset;
    signal wnext, rnext: states;
    constant ADDR_WEIGHTS_BASE : INTEGER := 16#40000#;
    constant ADDR_WEIGHTS_HIGH : INTEGER := 16#7ffff#;
    ...
    -- memory signals
    signal int_weights_address0 : UNSIGNED(15 downto 0);
    signal int_weights_ce0     : STD_LOGIC;
    signal int_weights_q0      : UNSIGNED(31 downto 0);
    signal int_weights_address1 : UNSIGNED(15 downto 0);
    ...
    component nnlayer_nnIn3_s_axi_ram is
        generic (
    ...
    end component nnlayer_nnIn3_s_axi_ram;
...
-- ----------------------- Instantiation------------------
-- int_weights
int_weights : nnlayer_nnIn3_s_axi_ram
generic map (
     MEM_STYLE => "block",
     MEM_TYPE  => "2P",
     BYTES     => 4,
...
-- ----------------------- AXI READ ----------------------
    ...
    RRESP   <= "00";  -- OKAY
    RVALID_t  <= '1' when (rstate = rddata) and (int_weights_read = '0') else '0';
    RVALID    <= RVALID_t;
...
-- ----------------------- Memory logic ------------------
    -- weights
    int_weights_address0 <= UNSIGNED(weights_address0);
    int_weights_ce0      <= weights_ce0;
    weights_q0           <= STD_LOGIC_VECTOR(RESIZE(int_weights_q0, 32));
    int_weights_address1 <= raddr(17 downto 2) when ar_hs = '1' else waddr(17 downto 2);
...
entity nnlayer_nnIn3_s_axi_ram is
    generic (
        MEM_STYLE : STRING :="auto";
        MEM_TYPE  : STRING :="S2P";
        BYTES   : INTEGER :=4;
...
end entity nnlayer_nnIn3_s_axi_ram;

architecture behave of nnlayer_nnIn3_s_axi_ram is
