...
entity nnlayer_store_result is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
    ...
    vSize_loc_dout : IN STD_LOGIC_VECTOR (28 downto 0);
    vSize_loc_empty_n : IN STD_LOGIC;
    vSize_loc_read : OUT STD_LOGIC;
...
architecture behav of nnlayer_store_result is 
...
attribute shreg_extract : string;
    ...
    signal icmp_ln102_reg_127 : STD_LOGIC_VECTOR (0 downto 0);
    signal gmem0_blk_n_B : STD_LOGIC;
    signal ap_CS_fsm_state72 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state72 : signal is "none";
    signal out_r_blk_n : STD_LOGIC;
    signal vSize_loc_blk_n : STD_LOGIC;
    signal out_r_read_reg_116 : STD_LOGIC_VECTOR (63 downto 0);
    signal vSize_loc_read_reg_121 : STD_LOGIC_VECTOR (28 downto 0);
    signal icmp_ln102_fu_83_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal trunc_ln102_fu_93_p1 : STD_LOGIC_VECTOR (27 downto 0);
    signal trunc_ln102_reg_131 : STD_LOGIC_VECTOR (27 downto 0);
    signal trunc_ln102_1_fu_96_p4 : STD_LOGIC_VECTOR (57 downto 0);
    signal trunc_ln102_1_reg_136 : STD_LOGIC_VECTOR (57 downto 0);
    ...
    signal grp_store_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_WDATA : STD_LOGIC_VECTOR (511 downto 0);
    signal grp_store_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_WSTRB : STD_LOGIC_VECTOR (63 downto 0);
    ...
    signal sext_ln102_fu_105_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal ap_block_state2_io : BOOLEAN;
    signal vSize_cast_i_i_fu_89_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_block_state72 : BOOLEAN;
    signal ap_block_state1 : BOOLEAN;
    signal icmp_ln102_fu_83_p0 : STD_LOGIC_VECTOR (28 downto 0);
    ...
    component nnlayer_store_result_Pipeline_mem_wr IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
...
begin
    grp_store_result_Pipeline_mem_wr_fu_73 : component nnlayer_store_result_Pipeline_mem_wr
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
        ...
        sext_ln102 => trunc_ln102_1_reg_136,
        trunc_ln => trunc_ln102_reg_131);
        ...
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if ((ap_continue = ap_const_logic_1)) then 
                    ap_done_reg <= ap_const_logic_0;
                elsif ((not(((icmp_ln102_reg_127 = ap_const_lv1_1) and (m_axi_gmem0_BVALID = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state72))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state1)) then
                icmp_ln102_reg_127 <= icmp_ln102_fu_83_p2;
                out_r_read_reg_116 <= out_r_dout;
                vSize_loc_read_reg_121 <= vSize_loc_dout;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state2) and (icmp_ln102_reg_127 = ap_const_lv1_1))) then
                trunc_ln102_1_reg_136 <= out_r_read_reg_116(63 downto 6);
                trunc_ln102_reg_131 <= trunc_ln102_fu_93_p1;
            end if;
        end if;
    end process;

    ap_NS_fsm_assign_proc : process (ap_start, ap_done_reg, ap_CS_fsm, ap_CS_fsm_state1, m_axi_gmem0_BVALID, out_r_empty_n, vSize_loc_empty_n, ap_CS_fsm_state2, icmp_ln102_reg_127, ap_CS_fsm_state72, grp_store_result_Pipeline_mem_wr_fu_73_ap_done, ap_CS_fsm_state4, ap_block_state2_io)
    begin
        case ap_CS_fsm is
            when ap_ST_fsm_state1 => 
                if ((not(((ap_done_reg = ap_const_logic_1) or (ap_start = ap_const_logic_0) or (vSize_loc_empty_n = ap_const_logic_0) or (out_r_empty_n = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then
                    ap_NS_fsm <= ap_ST_fsm_state2;
                else
                    ap_NS_fsm <= ap_ST_fsm_state1;
                end if;
            when ap_ST_fsm_state2 => 
                if (((ap_const_boolean_0 = ap_block_state2_io) and (ap_const_logic_1 = ap_CS_fsm_state2) and (icmp_ln102_reg_127 = ap_const_lv1_0))) then
                    ap_NS_fsm <= ap_ST_fsm_state72;
                elsif (((ap_const_boolean_0 = ap_block_state2_io) and (ap_const_logic_1 = ap_CS_fsm_state2) and (icmp_ln102_reg_127 = ap_const_lv1_1))) then
            ...
            when ap_ST_fsm_state72 => 
                if ((not(((icmp_ln102_reg_127 = ap_const_lv1_1) and (m_axi_gmem0_BVALID = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state72))) then
                    ap_NS_fsm <= ap_ST_fsm_state1;
                else
                    ap_NS_fsm <= ap_ST_fsm_state72;
                end if;
    ...
    ap_ST_fsm_state1_blk_assign_proc : process(ap_start, ap_done_reg, out_r_empty_n, vSize_loc_empty_n)
    begin
        if (((ap_done_reg = ap_const_logic_1) or (ap_start = ap_const_logic_0) or (vSize_loc_empty_n = ap_const_logic_0) or (out_r_empty_n = ap_const_logic_0))) then 
    ...
    ap_ST_fsm_state72_blk_assign_proc : process(m_axi_gmem0_BVALID, icmp_ln102_reg_127)
    begin
        if (((icmp_ln102_reg_127 = ap_const_lv1_1) and (m_axi_gmem0_BVALID = ap_const_logic_0))) then 
    ...
    ap_block_state1_assign_proc : process(ap_start, ap_done_reg, out_r_empty_n, vSize_loc_empty_n)
    begin
                ap_block_state1 <= ((ap_done_reg = ap_const_logic_1) or (ap_start = ap_const_logic_0) or (vSize_loc_empty_n = ap_const_logic_0) or (out_r_empty_n = ap_const_logic_0));
    end process;


    ap_block_state2_io_assign_proc : process(m_axi_gmem0_AWREADY, icmp_ln102_reg_127)
    begin
                ap_block_state2_io <= ((m_axi_gmem0_AWREADY = ap_const_logic_0) and (icmp_ln102_reg_127 = ap_const_lv1_1));
    end process;


    ap_block_state72_assign_proc : process(m_axi_gmem0_BVALID, icmp_ln102_reg_127)
    begin
                ap_block_state72 <= ((icmp_ln102_reg_127 = ap_const_lv1_1) and (m_axi_gmem0_BVALID = ap_const_logic_0));
    end process;


    ap_done_assign_proc : process(ap_done_reg, m_axi_gmem0_BVALID, icmp_ln102_reg_127, ap_CS_fsm_state72)
    begin
        if ((not(((icmp_ln102_reg_127 = ap_const_lv1_1) and (m_axi_gmem0_BVALID = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state72))) then 
    ...
    ap_ready_assign_proc : process(m_axi_gmem0_BVALID, icmp_ln102_reg_127, ap_CS_fsm_state72)
    begin
        if ((not(((icmp_ln102_reg_127 = ap_const_lv1_1) and (m_axi_gmem0_BVALID = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state72))) then 
    ...
    gmem0_blk_n_AW_assign_proc : process(m_axi_gmem0_AWREADY, ap_CS_fsm_state2, icmp_ln102_reg_127)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state2) and (icmp_ln102_reg_127 = ap_const_lv1_1))) then 
    ...
    gmem0_blk_n_B_assign_proc : process(m_axi_gmem0_BVALID, icmp_ln102_reg_127, ap_CS_fsm_state72)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state72) and (icmp_ln102_reg_127 = ap_const_lv1_1))) then 
    ...
    icmp_ln102_fu_83_p0 <= vSize_loc_dout;
    icmp_ln102_fu_83_p2 <= "1" when (signed(icmp_ln102_fu_83_p0) > signed(ap_const_lv29_0)) else "0";
    ...
    m_axi_gmem0_AWADDR_assign_proc : process(ap_CS_fsm_state2, icmp_ln102_reg_127, grp_store_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_AWADDR, ap_CS_fsm_state3, ap_CS_fsm_state4, sext_ln102_fu_105_p1, ap_block_state2_io)
    begin
        if (((ap_const_boolean_0 = ap_block_state2_io) and (ap_const_logic_1 = ap_CS_fsm_state2) and (icmp_ln102_reg_127 = ap_const_lv1_1))) then 
            m_axi_gmem0_AWADDR <= sext_ln102_fu_105_p1;
    ...
    m_axi_gmem0_AWLEN_assign_proc : process(ap_CS_fsm_state2, icmp_ln102_reg_127, grp_store_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_AWLEN, ap_CS_fsm_state3, ap_CS_fsm_state4, ap_block_state2_io, vSize_cast_i_i_fu_89_p1)
    begin
        if (((ap_const_boolean_0 = ap_block_state2_io) and (ap_const_logic_1 = ap_CS_fsm_state2) and (icmp_ln102_reg_127 = ap_const_lv1_1))) then 
            m_axi_gmem0_AWLEN <= vSize_cast_i_i_fu_89_p1;
        elsif (((ap_const_logic_1 = ap_CS_fsm_state4) or (ap_const_logic_1 = ap_CS_fsm_state3))) then 
            m_axi_gmem0_AWLEN <= grp_store_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_AWLEN;
        else 
    ...
    m_axi_gmem0_AWVALID_assign_proc : process(ap_CS_fsm_state2, icmp_ln102_reg_127, grp_store_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_AWVALID, ap_CS_fsm_state3, ap_CS_fsm_state4, ap_block_state2_io)
    begin
        if (((ap_const_boolean_0 = ap_block_state2_io) and (ap_const_logic_1 = ap_CS_fsm_state2) and (icmp_ln102_reg_127 = ap_const_lv1_1))) then 
    ...
    m_axi_gmem0_BREADY_assign_proc : process(m_axi_gmem0_BVALID, icmp_ln102_reg_127, ap_CS_fsm_state72, grp_store_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_BREADY, ap_CS_fsm_state3, ap_CS_fsm_state4)
    begin
        if ((not(((icmp_ln102_reg_127 = ap_const_lv1_1) and (m_axi_gmem0_BVALID = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state72) and (icmp_ln102_reg_127 = ap_const_lv1_1))) then 
    ...
    out_r_read_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, out_r_empty_n, vSize_loc_empty_n)
    begin
        if ((not(((ap_done_reg = ap_const_logic_1) or (ap_start = ap_const_logic_0) or (vSize_loc_empty_n = ap_const_logic_0) or (out_r_empty_n = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    begin
        ...
        sext_ln102_fu_105_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(trunc_ln102_1_fu_96_p4),64));

    trunc_ln102_1_fu_96_p4 <= out_r_read_reg_116(63 downto 6);
    trunc_ln102_fu_93_p1 <= vSize_loc_read_reg_121(28 - 1 downto 0);
        vSize_cast_i_i_fu_89_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(vSize_loc_read_reg_121),32));


    vSize_loc_blk_n_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, vSize_loc_empty_n)
    begin
        if ((not(((ap_done_reg = ap_const_logic_1) or (ap_start = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
            vSize_loc_blk_n <= vSize_loc_empty_n;
        else 
            vSize_loc_blk_n <= ap_const_logic_1;
        end if; 
    end process;


    vSize_loc_read_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, out_r_empty_n, vSize_loc_empty_n)
    begin
        if ((not(((ap_done_reg = ap_const_logic_1) or (ap_start = ap_const_logic_0) or (vSize_loc_empty_n = ap_const_logic_0) or (out_r_empty_n = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
            vSize_loc_read <= ap_const_logic_1;
        else 
            vSize_loc_read <= ap_const_logic_0;
        end if; 
    end process;
