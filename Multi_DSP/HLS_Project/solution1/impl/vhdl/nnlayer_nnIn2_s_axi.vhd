...
port (
    ...
    output_r_q0           :out  STD_LOGIC_VECTOR(31 downto 0)
);
end entity nnlayer_nnIn2_s_axi;

-- ------------------------Address Info-------------------
-- 0x400 ~
-- 0x7ff : Memory 'output_r' (256 * 32b)
--         Word n : bit [31:0] - output_r[n]
-- (SC = Self Clear, COR = Clear on Read, TOW = Toggle on Write, COH = Clear on Handshake)

architecture behave of nnlayer_nnIn2_s_axi is
    type states is (wridle, wrdata, wrresp, wrreset, rdidle, rddata, rdreset);  -- read and write fsm states
    signal wstate  : states := wrreset;
    signal rstate  : states := rdreset;
    signal wnext, rnext: states;
    constant ADDR_OUTPUT_R_BASE : INTEGER := 16#400#;
    constant ADDR_OUTPUT_R_HIGH : INTEGER := 16#7ff#;
    ...
    -- memory signals
    signal int_output_r_address0 : UNSIGNED(7 downto 0);
    ...
    signal int_output_r_address1 : UNSIGNED(7 downto 0);
    ...
    component nnlayer_nnIn2_s_axi_ram is
        generic (
    ...
    end component nnlayer_nnIn2_s_axi_ram;
...
-- ----------------------- Instantiation------------------
-- int_output_r
int_output_r : nnlayer_nnIn2_s_axi_ram
generic map (
     MEM_STYLE => "block",
     MEM_TYPE  => "T2P",
     BYTES     => 4,
...
-- ----------------------- Memory logic ------------------
    ...
    output_r_q0          <= STD_LOGIC_VECTOR(RESIZE(int_output_r_q0, 32));
    int_output_r_address1 <= raddr(9 downto 2) when ar_hs = '1' else waddr(9 downto 2);
...
entity nnlayer_nnIn2_s_axi_ram is
    generic (
        MEM_STYLE : STRING :="auto";
        MEM_TYPE  : STRING :="S2P";
        BYTES   : INTEGER :=4;
...
end entity nnlayer_nnIn2_s_axi_ram;

architecture behave of nnlayer_nnIn2_s_axi_ram is
