...
module nnlayer_nnlayer_Pipeline_VITIS_LOOP_99_2 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [63:0] idxprom7_i_cast_fu_3054_p1;
...
wire   [13:0] zext_ln99_fu_3084_p1;
wire   [13:0] add_ln101_fu_3092_p2;
wire   [6:0] trunc_ln101_fu_3088_p1;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln99_fu_3072_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        output_V_addr_reg_3830 <= idxprom7_i_cast_fu_3054_p1;
...
always @ (posedge ap_clk) begin
    if (((icmp_ln99_fu_3072_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ifzero_reg_4489 <= ifzero_fu_3502_p2;
        lshr_ln_reg_3839 <= {{add_ln101_fu_3092_p2[13:7]}};
        tmp_1_reg_4484 <= tmp_1_fu_3240_p130;
    end
end

always @ (*) begin
    if (((icmp_ln99_fu_3072_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign add_ln101_fu_3092_p2 = (mul_i + zext_ln99_fu_3084_p1);
...
assign icmp_ln99_fu_3072_p2 = ((ap_sig_allocacmp_inNeurons_1 == 8'd128) ? 1'b1 : 1'b0);

assign idxprom7_i_cast_fu_3054_p1 = idxprom7_i;
...
assign trunc_ln101_fu_3088_p1 = ap_sig_allocacmp_inNeurons_1[6:0];
...
assign zext_ln1169_fu_3108_p1 = trunc_ln101_fu_3088_p1;

assign zext_ln99_fu_3084_p1 = ap_sig_allocacmp_inNeurons_1;

endmodule //nnlayer_nnlayer_Pipeline_VITIS_LOOP_99_2
