...
//------------------------Parameter----------------------
localparam
    ADDR_BIAS_BASE = 11'h400,
    ADDR_BIAS_HIGH = 11'h7ff,
    WRIDLE         = 2'd0,
    WRDATA         = 2'd1,
    WRRESP         = 2'd2,
    WRRESET        = 2'd3,
...
//------------------------Local signal-------------------
    ...
    // memory signals
    wire [7:0]                    int_bias_address0;
    wire                          int_bias_ce0;
    wire [31:0]                   int_bias_q0;
    wire [7:0]                    int_bias_address1;
    wire                          int_bias_ce1;
    wire                          int_bias_we1;
...
assign RVALID  = (rstate == RDDATA) & !int_bias_read;
...
assign int_bias_address1 = ar_hs? raddr[9:2] : waddr[9:2];
...
module nnlayer_nnIn4_s_axi_ram
#(parameter
    MEM_STYLE = "auto",
    MEM_TYPE  = "S2P",
    BYTES  = 4,
