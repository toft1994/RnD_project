...
module nnlayer_multiDSP_nnlayer_multiDSP_Pipeline_VITIS_LOOP_16_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
assign i_3_fu_1731_p2 = (ap_sig_allocacmp_i + 16'd1);

assign icmp_ln16_fu_1725_p2 = ((ap_sig_allocacmp_i == numOfOutputNeurons) ? 1'b1 : 1'b0);

assign output_V_address0 = zext_ln18_fu_1737_p1;

assign tmp_fu_1751_p3 = output_V_q0[32'd15];

assign trunc_ln20_fu_1742_p1 = ap_sig_allocacmp_i[6:0];

assign zext_ln18_fu_1737_p1 = ap_sig_allocacmp_i;

endmodule //nnlayer_multiDSP_nnlayer_multiDSP_Pipeline_VITIS_LOOP_16_1
