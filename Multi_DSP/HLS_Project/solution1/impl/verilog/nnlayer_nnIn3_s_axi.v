...
//------------------------Parameter----------------------
localparam
    ADDR_WEIGHTS_BASE = 19'h40000,
    ADDR_WEIGHTS_HIGH = 19'h7ffff,
    WRIDLE            = 2'd0,
    WRDATA            = 2'd1,
    WRRESP            = 2'd2,
    WRRESET           = 2'd3,
...
//------------------------Local signal-------------------
    ...
    // memory signals
    wire [15:0]                   int_weights_address0;
    wire                          int_weights_ce0;
    wire [31:0]                   int_weights_q0;
    wire [15:0]                   int_weights_address1;
...
assign RVALID  = (rstate == RDDATA) & !int_weights_read;
...
//------------------------Memory logic-------------------
// weights
assign int_weights_address0 = weights_address0;
assign int_weights_ce0      = weights_ce0;
assign weights_q0           = int_weights_q0;
assign int_weights_address1 = ar_hs? raddr[17:2] : waddr[17:2];
...
module nnlayer_nnIn3_s_axi_ram
#(parameter
    MEM_STYLE = "auto",
    MEM_TYPE  = "S2P",
    BYTES  = 4,
