...
localparam
    ...
    ADDR_INPUT_R_DATA_1        = 9'h014,
    ADDR_INPUT_R_CTRL          = 9'h018,
    ADDR_WEIGHTS_DATA_0        = 9'h01c,
    ADDR_WEIGHTS_DATA_1        = 9'h020,
    ADDR_WEIGHTS_CTRL          = 9'h024,
    ADDR_BIAS_DATA_0           = 9'h028,
    ADDR_BIAS_DATA_1           = 9'h02c,
    ADDR_BIAS_CTRL             = 9'h030,
    ADDR_NUMOFINNEURONS_DATA_0 = 9'h034,
    ADDR_NUMOFINNEURONS_CTRL   = 9'h038,
    ADDR_OUTPUT_R_BASE         = 9'h100,
    ADDR_OUTPUT_R_HIGH         = 9'h1ff,
    WRIDLE                     = 2'd0,
    WRDATA                     = 2'd1,
    WRRESP                     = 2'd2,
    WRRESET                    = 2'd3,
