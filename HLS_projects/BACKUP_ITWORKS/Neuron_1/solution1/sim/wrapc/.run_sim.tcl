...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "runLayer.autotvin.dat"
	set constFileTvOut       "runLayer.autotvout.dat"
	set constFileHdlTvIn     "runLayer.autohdltvin.dat"
	set constFileHdlTvOut    "runLayer.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
