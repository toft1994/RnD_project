...
if {[file isfile runLayer.autotvin.dat]} {
	file delete -force runLayer.autotvin.dat
}

if {[file isfile runLayer.autotvout.dat]} {
	file delete -force runLayer.autotvout.dat
}
