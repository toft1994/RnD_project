...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.runLayer.autotvin_input_r.dat"
         "c.runLayer.autotvin_weights.dat"
         "c.runLayer.autotvin_bias.dat"
         "c.runLayer.autotvin_numOfInNeurons.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.runLayer.autotvout_output_r.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
