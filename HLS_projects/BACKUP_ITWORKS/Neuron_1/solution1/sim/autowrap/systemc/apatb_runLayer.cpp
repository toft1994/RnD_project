...
// wrapc file define:
#define AUTOTB_TVIN_input_r "../tv/cdatafile/c.runLayer.autotvin_input_r.dat"
#define AUTOTB_TVOUT_input_r "../tv/cdatafile/c.runLayer.autotvout_input_r.dat"
// wrapc file define:
#define AUTOTB_TVIN_output_r "../tv/cdatafile/c.runLayer.autotvin_output_r.dat"
#define AUTOTB_TVOUT_output_r "../tv/cdatafile/c.runLayer.autotvout_output_r.dat"
// wrapc file define:
#define AUTOTB_TVIN_weights "../tv/cdatafile/c.runLayer.autotvin_weights.dat"
#define AUTOTB_TVOUT_weights "../tv/cdatafile/c.runLayer.autotvout_weights.dat"
// wrapc file define:
#define AUTOTB_TVIN_bias "../tv/cdatafile/c.runLayer.autotvin_bias.dat"
#define AUTOTB_TVOUT_bias "../tv/cdatafile/c.runLayer.autotvout_bias.dat"
// wrapc file define:
#define AUTOTB_TVIN_numOfInNeurons "../tv/cdatafile/c.runLayer.autotvin_numOfInNeurons.dat"
#define AUTOTB_TVOUT_numOfInNeurons "../tv/cdatafile/c.runLayer.autotvout_numOfInNeurons.dat"

#define INTER_TCL "../tv/cdatafile/ref.tcl"

// tvout file define:
#define AUTOTB_TVOUT_PC_input_r "../tv/rtldatafile/rtl.runLayer.autotvout_input_r.dat"
// tvout file define:
#define AUTOTB_TVOUT_PC_output_r "../tv/rtldatafile/rtl.runLayer.autotvout_output_r.dat"
// tvout file define:
#define AUTOTB_TVOUT_PC_weights "../tv/rtldatafile/rtl.runLayer.autotvout_weights.dat"
// tvout file define:
#define AUTOTB_TVOUT_PC_bias "../tv/rtldatafile/rtl.runLayer.autotvout_bias.dat"
// tvout file define:
#define AUTOTB_TVOUT_PC_numOfInNeurons "../tv/rtldatafile/rtl.runLayer.autotvout_numOfInNeurons.dat"
...
static bool RTLOutputCheckAndReplacement(std::string &AESL_token, std::string PortName) {
  ...
  return err;}
extern "C" void runLayer_hw_stub_wrapper(volatile void *, volatile void *, volatile void *, volatile void *, short);

extern "C" void apatb_runLayer_hw(volatile void * __xlx_apatb_param_input_r, volatile void * __xlx_apatb_param_output_r, volatile void * __xlx_apatb_param_weights, volatile void * __xlx_apatb_param_bias, short __xlx_apatb_param_numOfInNeurons) {
...
tr.reorder();
tr.send<2>((char*)__xlx_apatb_param_output_r, 3);
}
#else
{
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          std::vector<sc_bv<16> > output_r_pc_buffer(3);
          int i = 0;
          ...
          if (i > 0) {{
            int i = 0;
            for (int j = 0, e = 3; j < e; j += 1, ++i) {((char*)__xlx_apatb_param_output_r)[j*2+0] = output_r_pc_buffer[i].range(7, 0).to_int64();
...
tr.import<2>((char*)__xlx_apatb_param_output_r, 3, 0);
  }
tr.reorder();
aesl_fh.write(AUTOTB_TVIN_output_r, tr.p, tr.tbytes);
}

  tcl_file.set_num(3, &tcl_file.output_r_depth);
#else
...
tr.import<2>((char*)__xlx_apatb_param_weights, 384, 0);
  }
tr.reorder();
aesl_fh.write(AUTOTB_TVIN_weights, tr.p, tr.tbytes);
}

  tcl_file.set_num(384, &tcl_file.weights_depth);
#else
...
tr.import<2>((char*)__xlx_apatb_param_bias, 3, 0);
  }
tr.reorder();
aesl_fh.write(AUTOTB_TVIN_bias, tr.p, tr.tbytes);
}

  tcl_file.set_num(3, &tcl_file.bias_depth);
#else
...
runLayer_hw_stub_wrapper(__xlx_apatb_param_input_r, __xlx_apatb_param_output_r, __xlx_apatb_param_weights, __xlx_apatb_param_bias, __xlx_apatb_param_numOfInNeurons);
