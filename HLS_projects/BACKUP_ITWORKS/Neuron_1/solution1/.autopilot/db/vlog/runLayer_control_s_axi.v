...
#(parameter
    ...
    input  wire [8:0]                    weights_address0,
...
localparam
    ...
    ADDR_IER                   = 11'h008,
    ADDR_ISR                   = 11'h00c,
    ADDR_NUMOFINNEURONS_DATA_0 = 11'h020,
    ADDR_NUMOFINNEURONS_CTRL   = 11'h024,
    ADDR_OUTPUT_R_BASE         = 11'h010,
    ADDR_OUTPUT_R_HIGH         = 11'h017,
    ADDR_BIAS_BASE             = 11'h018,
    ADDR_BIAS_HIGH             = 11'h01f,
    ADDR_INPUT_R_BASE          = 11'h100,
    ADDR_INPUT_R_HIGH          = 11'h1ff,
    ADDR_WEIGHTS_BASE          = 11'h400,
    ADDR_WEIGHTS_HIGH          = 11'h7ff,
    WRIDLE                     = 2'd0,
    WRDATA                     = 2'd1,
    WRRESP                     = 2'd2,
    WRRESET                    = 2'd3,
...
//------------------------Local signal-------------------
    ...
    wire [0:0]                    int_bias_address0;
    wire                          int_bias_ce0;
    wire [31:0]                   int_bias_q0;
    wire [0:0]                    int_bias_address1;
    wire                          int_bias_ce1;
    wire                          int_bias_we1;
    ...
    wire [7:0]                    int_weights_address0;
    wire                          int_weights_ce0;
    wire [31:0]                   int_weights_q0;
    wire [7:0]                    int_weights_address1;
...
assign RVALID  = (rstate == RDDATA) & !int_output_r_read & !int_bias_read & !int_input_r_read & !int_weights_read;
...
assign int_bias_address1     = ar_hs? raddr[2:2] : waddr[2:2];
...
assign int_weights_address1  = ar_hs? raddr[9:2] : waddr[9:2];
