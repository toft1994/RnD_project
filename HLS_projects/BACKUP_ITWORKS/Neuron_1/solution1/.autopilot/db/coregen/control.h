...
#define CONTROL_ADDR_NUMOFINNEURONS_DATA 0x020
#define CONTROL_BITS_NUMOFINNEURONS_DATA 16
#define CONTROL_ADDR_OUTPUT_R_BASE       0x010
#define CONTROL_ADDR_OUTPUT_R_HIGH       0x017
#define CONTROL_WIDTH_OUTPUT_R           16
#define CONTROL_DEPTH_OUTPUT_R           3
#define CONTROL_ADDR_BIAS_BASE           0x018
#define CONTROL_ADDR_BIAS_HIGH           0x01f
#define CONTROL_WIDTH_BIAS               16
#define CONTROL_DEPTH_BIAS               3
#define CONTROL_ADDR_INPUT_R_BASE        0x100
#define CONTROL_ADDR_INPUT_R_HIGH        0x1ff
#define CONTROL_WIDTH_INPUT_R            16
#define CONTROL_DEPTH_INPUT_R            128
#define CONTROL_ADDR_WEIGHTS_BASE        0x400
#define CONTROL_ADDR_WEIGHTS_HIGH        0x7ff
#define CONTROL_WIDTH_WEIGHTS            16
#define CONTROL_DEPTH_WEIGHTS            384
