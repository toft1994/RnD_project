...
extern "C" void runLayer(short*, short*, short*, short*, short);
extern "C" void apatb_runLayer_hw(volatile void * __xlx_apatb_param_input_r, volatile void * __xlx_apatb_param_output_r, volatile void * __xlx_apatb_param_weights, volatile void * __xlx_apatb_param_bias, short __xlx_apatb_param_numOfInNeurons) {
  ...
  int __xlx_size_param_output_r = 3;
  ...
  int __xlx_size_param_weights = 384;
  ...
  // DUT call
  runLayer(__xlx_input_r__input_buffer, __xlx_output_r__input_buffer, __xlx_weights__input_buffer, __xlx_bias__input_buffer, __xlx_apatb_param_numOfInNeurons);
