set moduleName nnlayer_Pipeline_VITIS_LOOP_32_1
set isTopModule 0
...
set C_modelName {nnlayer_Pipeline_VITIS_LOOP_32_1}
set C_modelType { void 0 }
set C_modelArgList {
	{ numOfOutNeurons int 16 regular  }
	{ bias int 16 regular {array 256 { 1 } 1 1 }  }
	{ output_r int 16 regular {array 256 { 0 } 0 1 }  }
}
...
set portList { 
	...
	{ numOfOutNeurons sc_in sc_lv 16 signal 0 } 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		"CDFG" : "nnlayer_Pipeline_VITIS_LOOP_32_1",
		"Protocol" : "ap_ctrl_hs",
...
set ArgLastReadFirstWriteLatency {
	nnlayer_Pipeline_VITIS_LOOP_32_1 {
...
set Spec2ImplPortList { 
	...
	bias { ap_memory {  { bias_address0 mem_address 1 8 }  { bias_ce0 mem_ce 1 1 }  { bias_q0 in_data 0 16 } } }
