...
# 6 "Neuron_1/1_neuron_layer.hpp" 2
...
#pragma HLS INTERFACE mode=s_axilite port=return
 ...
 VITIS_LOOP_32_1: for (outNeurons = 0; outNeurons < numOfOutNeurons; outNeurons++) {
  output[outNeurons] = bias[outNeurons];
 }

 VITIS_LOOP_36_2: for (outNeurons = 0; outNeurons < numOfOutNeurons; outNeurons++)
 {
  VITIS_LOOP_38_3: for (short int inNeurons = 0; inNeurons < numOfInNeurons; inNeurons++)
  {
#pragma HLS UNROLL
