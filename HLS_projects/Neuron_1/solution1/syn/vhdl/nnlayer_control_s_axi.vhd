...
architecture behave of nnlayer_control_s_axi is
    ...
    constant ADDR_NUMOFINNEURONS_DATA_0  : INTEGER := 16#00010#;
    constant ADDR_NUMOFINNEURONS_CTRL    : INTEGER := 16#00014#;
    constant ADDR_NUMOFOUTNEURONS_DATA_0 : INTEGER := 16#00018#;
