...
set hdl_module_list {nnlayer_mac_muladd_16s_16s_16ns_16_4_1
nnlayer_flow_control_loop_pipe_sequential_init
nnlayer_flow_control_loop_pipe_sequential_init
nnlayer_control_s_axi
nnlayer_Pipeline_VITIS_LOOP_35_2
...
set Interfaces {
    s_axi_control {
        ...
        registers {{0x00 CTRL RW 0x0 {Control signals} {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 1 RESERVED_2 R 0 "Reserved.  0s on read." } { 9 1 RESERVED_3 R 0 "Reserved.  0s on read." } { 10 22 RESERVED_4 R 0 "Reserved.  0s on read." }}} {0x04 GIER RW 0x0 {Global Interrupt Enable Register} {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }}} {0x08 IP_IER RW 0x0 {IP Interrupt Enable Register} {{0 1 CHAN0_INT_EN RW 0 {Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled.}} {1 1 CHAN1_INT_EN RW 0 {Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled.}} {2 3 RESERVED_0 R 0 {Reserved.  0s on read.}} {5 1 CHAN2_INT_EN RW 0 {Enable Channel 2 (ap_local_deadlock) Interrupt.  0 = Disabled, 1 = Enabled.}} {6 26 RESERVED_1 R 0 {Reserved.  0s on read.}}}} {0x0c IP_ISR RW 0x0 {IP Interrupt Status Register} {{0 1 CHAN0_INT_ST RTOW 0 {Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup}} {1 1 CHAN1_INT_ST RTOW 0 {Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup}} {2 3 RESERVED_0 R 0 {Reserved.  0s on read.}} {5 1 CHAN2_INT_ST RTOW 0 {Channel 2 (ap_local_deadlock) Interrupt Status. 0 = No Channel 2 input interrupt, 1 = Channel 2 input interrup}} {6 26 RESERVED_1 R 0 {Reserved.  0s on read.}}}} {0x10 numOfInNeurons W 0x0 "Data signal of numOfInNeurons" {{0 16 numOfInNeurons W 0 "Bit 15 to 0 of numOfInNeurons"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x18 numOfOutNeurons W 0x0 "Data signal of numOfOutNeurons" {{0 16 numOfOutNeurons W 0 "Bit 15 to 0 of numOfOutNeurons"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x20 activation W 0x0 "Data signal of activation" {{0 8 activation W 0 "Bit 7 to 0 of activation"} {8 24 RESERVED R 0 "Reserved.  0s on read."}}}}
        memories "input_r {base_address 256 range 256} output_r {base_address 512 range 512} bias {base_address 1024 range 512} weights {base_address 65536 range 65536}"
        ctype {
            AWVALID {
                Type "bool"
                Width "1"
