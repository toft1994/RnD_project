...
# 3 "HLS_Project/neural_layer.cpp" 2
...
#pragma HLS inline
 VITIS_LOOP_10_1: for (short int i = 0; i < 256; i++)
 {
#pragma HLS PIPELINE
 if (data[i] < 0)
  {
...
# 20 "HLS_Project/neural_layer.cpp"
...
#pragma HLS INTERFACE mode=s_axilite port=return
 ...
 VITIS_LOOP_33_1: for (outNeurons = 0; outNeurons < numOfOutNeurons; outNeurons++) {
  output[outNeurons] = bias[outNeurons];
 }

 VITIS_LOOP_37_2: for (inNeurons = 0; inNeurons < numOfInNeurons; inNeurons++)
 {
  VITIS_LOOP_39_3: for (outNeurons = 0; outNeurons < numOfOutNeurons; outNeurons++)
  {
#pragma HLS UNROLL
