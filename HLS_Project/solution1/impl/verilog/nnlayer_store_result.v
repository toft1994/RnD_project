...
reg   [0:0] icmp_ln102_reg_127;
reg    gmem0_blk_n_B;
wire    ap_CS_fsm_state72;
reg    out_r_blk_n;
reg    vSize_loc_blk_n;
reg   [63:0] out_r_read_reg_116;
reg  signed [28:0] vSize_loc_read_reg_121;
wire   [0:0] icmp_ln102_fu_83_p2;
wire   [27:0] trunc_ln102_fu_93_p1;
reg   [27:0] trunc_ln102_reg_131;
wire  signed [57:0] trunc_ln102_1_fu_96_p4;
reg   [57:0] trunc_ln102_1_reg_136;
...
wire   [511:0] grp_store_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_WDATA;
wire   [63:0] grp_store_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_WSTRB;
...
wire  signed [63:0] sext_ln102_fu_105_p1;
reg    ap_block_state2_io;
wire  signed [31:0] vSize_cast_i_i_fu_89_p1;
reg    ap_block_state72;
reg    ap_block_state1;
wire  signed [28:0] icmp_ln102_fu_83_p0;
reg   [71:0] ap_NS_fsm;
...
nnlayer_store_result_Pipeline_mem_wr grp_store_result_Pipeline_mem_wr_fu_73(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if ((~((icmp_ln102_reg_127 == 1'd1) & (m_axi_gmem0_BVALID == 1'b0)) & (1'b1 == ap_CS_fsm_state72))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state2) & (icmp_ln102_reg_127 == 1'd1))) begin
        trunc_ln102_1_reg_136 <= {{out_r_read_reg_116[63:6]}};
...
always @ (*) begin
    if (((ap_done_reg == 1'b1) | (ap_start == 1'b0) | (vSize_loc_empty_n == 1'b0) | (out_r_empty_n == 1'b0))) begin
...
always @ (*) begin
    if (((icmp_ln102_reg_127 == 1'd1) & (m_axi_gmem0_BVALID == 1'b0))) begin
...
always @ (*) begin
    if ((~((icmp_ln102_reg_127 == 1'd1) & (m_axi_gmem0_BVALID == 1'b0)) & (1'b1 == ap_CS_fsm_state72))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state72) & (icmp_ln102_reg_127 == 1'd1))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_state2_io) & (1'b1 == ap_CS_fsm_state2) & (icmp_ln102_reg_127 == 1'd1))) begin
...
always @ (*) begin
    if ((~((icmp_ln102_reg_127 == 1'd1) & (m_axi_gmem0_BVALID == 1'b0)) & (1'b1 == ap_CS_fsm_state72) & (icmp_ln102_reg_127 == 1'd1))) begin
...
always @ (*) begin
    if ((~((ap_done_reg == 1'b1) | (ap_start == 1'b0) | (vSize_loc_empty_n == 1'b0) | (out_r_empty_n == 1'b0)) & (1'b1 == ap_CS_fsm_state1))) begin
        out_r_read = 1'b1;
    end else begin
        out_r_read = 1'b0;
    end
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state2 : begin
            if (((1'b0 == ap_block_state2_io) & (1'b1 == ap_CS_fsm_state2) & (icmp_ln102_reg_127 == 1'd0))) begin
                ap_NS_fsm = ap_ST_fsm_state72;
            end else if (((1'b0 == ap_block_state2_io) & (1'b1 == ap_CS_fsm_state2) & (icmp_ln102_reg_127 == 1'd1))) begin
...
always @ (*) begin
    ap_block_state1 = ((ap_done_reg == 1'b1) | (ap_start == 1'b0) | (vSize_loc_empty_n == 1'b0) | (out_r_empty_n == 1'b0));
end

always @ (*) begin
    ap_block_state2_io = ((m_axi_gmem0_AWREADY == 1'b0) & (icmp_ln102_reg_127 == 1'd1));
end

always @ (*) begin
    ap_block_state72 = ((icmp_ln102_reg_127 == 1'd1) & (m_axi_gmem0_BVALID == 1'b0));
end

assign grp_store_result_Pipeline_mem_wr_fu_73_ap_start = grp_store_result_Pipeline_mem_wr_fu_73_ap_start_reg;

assign icmp_ln102_fu_83_p0 = vSize_loc_dout;

assign icmp_ln102_fu_83_p2 = (($signed(icmp_ln102_fu_83_p0) > $signed(29'd0)) ? 1'b1 : 1'b0);
...
assign sext_ln102_fu_105_p1 = trunc_ln102_1_fu_96_p4;

assign trunc_ln102_1_fu_96_p4 = {{out_r_read_reg_116[63:6]}};

assign trunc_ln102_fu_93_p1 = vSize_loc_read_reg_121[27:0];

assign vSize_cast_i_i_fu_89_p1 = vSize_loc_read_reg_121;

endmodule //nnlayer_store_result
