...
//------------------------Parameter----------------------
localparam
    ADDR_OUTPUT_R_BASE = 11'h400,
    ADDR_OUTPUT_R_HIGH = 11'h7ff,
    WRIDLE             = 2'd0,
    WRDATA             = 2'd1,
    WRRESP             = 2'd2,
    WRRESET            = 2'd3,
...
assign int_output_r_address1 = ar_hs? raddr[9:2] : waddr[9:2];
...
module nnlayer_nnIn2_s_axi_ram
#(parameter
    MEM_STYLE = "auto",
    MEM_TYPE  = "S2P",
    BYTES  = 4,
