...
attribute shreg_extract : string;
    ...
    signal i_5_fu_185_p2 : STD_LOGIC_VECTOR (8 downto 0);
...
begin
    mul_48s_50ns_97_2_1_U18 : component nnlayer_mul_48s_50ns_97_2_1
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 48,
    ...
    sdiv_96ns_44s_64_100_1_U19 : component nnlayer_sdiv_96ns_44s_64_100_1
    generic map (
        ID => 1,
        NUM_STAGE => 100,
        din0_WIDTH => 96,
    ...
    mul_64s_32s_64_5_1_U20 : component nnlayer_mul_64s_32s_64_5_1
    generic map (
        ID => 1,
        NUM_STAGE => 5,
        din0_WIDTH => 64,
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln48_fu_179_p2 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                resArray_V_addr_reg_502 <= zext_ln50_fu_191_p1(8 - 1 downto 0);
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    i_5_fu_185_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_i_4) + unsigned(ap_const_lv9_1));
    ...
    output_V_address0 <= zext_ln50_fu_191_p1(8 - 1 downto 0);
